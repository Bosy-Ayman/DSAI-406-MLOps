...
12| 04-27 | Kubernetes | Kubernetes, cluster architecture, nodes, pods, service, volume, control plane | [Lecture 7](lectures/lec7.md) | Lab Quiz + [Assignment 8](assignments/assign8.md) 
13| 05-04 | Kubernetes - Deployment  | deployment file, structure of the yaml, service, cluster inspection | [Lecture 8](lectures/lec8.md) | [Assignment 9](assignments/assign9.md)
14| 05-11 | kubeflow + Monitoring and Logging | GHA vs kubeflow, monitoring and logging, data, model, and service monitoring | [Lecture 9](lectures/lec9.md) | Final lab exam
